...
public abstract class MicroService implements Runnable {
    ...
    private HashMap<Class<? extends Message>,Callback<? extends Message>> typeToCallback;
    public ConcurrentLinkedDeque<Class<? extends Message>> messageTypes;
    ...
    public MicroService(String name) {
        this.name = name;
        typeToCallback=new HashMap<>();
        mb=MessageBusImpl.getInstance();
        messageTypes= new ConcurrentLinkedDeque<>();
    }
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        ...
        if(typeToCallback.get(type)==null){
            typeToCallback.put(type,callback);
        }
    }
    ...
    protected final void terminateAndUnregister() {
        this.terminated = true;
        mb.unregister(this);
    }
    ...
    public final void run() {
        ...
        while (!terminated) {
            try {
                ...
                Callback call=typeToCallback.get(m.getClass());
                call.call(m);
